...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid">
            <form method="get" action="InstructorController" class="viewTimeTable">
                <div> Campus: 
                        ...
                        <c:forEach var="s" items="${slist}">
                            <tr>
                                ...
                                <c:if test="${s.isStatus()}">
                                    <th><a href="AttendenceController?sid=${s.getId()}&status=${s.isStatus()}">View</a></th>
                                    </c:if>
                                    <c:if test="${!s.isStatus()}">
                                    <th><a href="AttendenceController?sid=${s.getId()}&status=${s.isStatus()}">Check</a></th>
                                    </c:if>
                            </tr>
                        </c:forEach>
                    </tbody>
